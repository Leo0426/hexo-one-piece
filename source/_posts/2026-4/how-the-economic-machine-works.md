...
{% mermaid %}
mindmap
  root((《经济机器是怎样运行的》每章金句))
    trade["**一、交易**"]
      tradeQuote["复杂的经济系统，最底层只是不断发生的交易。"]
    credit["**二、信用**"]
      creditQuote["货币决定你能花多少钱，信用决定你能把未来的钱提前花到今天。"]
    spending["**三、支出**"]
      spendingQuote["经济上升时，大家看到的是机会；经济下降时，大家感受到的是彼此的收缩。"]
    debtCycle["**四、短期波动**"]
      debtCycleQuote["长期决定命运的是生产率，短期制造波动的是债务周期。"]
    boomBust["**五、繁荣与衰退**"]
      boomBustQuote["繁荣不是永恒的奖励，很多时候，它只是下一轮衰退的起点。"]
    longDebt["**六、长期债务周期**"]
      longDebtQuote["经济危机往往不是突然发生的，它只是把长期积累的问题一次性暴露出来。"]
    deleveraging["**七、去杠杆**"]
      deleveragingQuote["债务不是问题，无法偿还的债务才是问题。"]
    rateCut["**八、降息失灵**"]
      rateCutQuote["当市场最害怕的不是利率，而是未来时，降息也可能失灵。"]
    crisisTools["**九、危机解法**"]
      crisisToolsQuote["危机从来不是“有没有代价”的问题，而是“谁承担代价、以什么方式承担”的问题。"]
    moneyPrint["**十、印钱救火**"]
      moneyPrintQuote["货币宽松能延缓崩塌，但不能替代真实增长。"]
    orderlyPain["**十一、有序去杠杆**"]
      orderlyPainQuote["真正成熟的经济治理，不是避免周期，而是避免周期失控。"]
    productivity["**十二、生产率**"]
      productivityQuote["杠杆可以放大增长，生产率才能定义增长。"]
    keySignals["**十三、三条线索**"]
      keySignalsQuote["短期，经济看信用；长期，经济看效率。"]
{% endmermaid %}
