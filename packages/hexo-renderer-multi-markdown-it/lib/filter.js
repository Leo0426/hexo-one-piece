...
var CleanCSS = require('clean-css'),
    ...
    Htmlminifier = require('html-minifier-terser').minify;
...
function logic_html(str, data) {
    ...
    return Promise.resolve(Htmlminifier(str, options)).then(function (result) {
        var saved = str.length ? ((str.length - result.length) / str.length * 100).toFixed(2) : '0.00';
        if (options.logger) {
